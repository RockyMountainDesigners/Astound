...
function astound_setup() {
	 ...
	 * If you're building a theme based on Astound, use a find and replace
	 * to change 'astound' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'astound', get_template_directory() . '/languages' );
...
function astound_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'astound_content_width', 640 );
}
...
function astound_scripts() {
	...
	wp_enqueue_script( 'astound-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'astound-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	wp_enqueue_script('jquery');

	wp_enqueue_style('bootstrap-3-css', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css');

	wp_enqueue_script('bootstrap-3-js', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js', array(), '20160514', true);
